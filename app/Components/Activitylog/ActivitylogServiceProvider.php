...
//        }
    ...
    public function register()
    {
        $this->app->bind(
            'activity',
            'App\Components\Activitylog\ActivitylogSupervisor'
        );

        $this->app->bind(
            'App\Components\Activitylog\Handlers\ActivitylogHandlerInterface',
            'App\Components\Activitylog\Handlers\EloquentHandler'
        );
    }
