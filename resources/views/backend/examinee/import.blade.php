...
@section('content')
    <div id="page-inner" class="import-question">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="text-center">Import danh sách thí sinh</h2>
            </div>
        </div>
        <!-- /. ROW  -->
        <hr/>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <form method="POST" action="/examinee/import" class="form-horizontal box"
                        ...
                        <div class="col-md-6">
                            <div class="text-center">
                                <div class="upload-group text-center">
                                    <input type="file" name="examinee" id="file-6"
